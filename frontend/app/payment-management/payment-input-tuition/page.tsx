...
export default function PaymentSettingsPage() {
    ...
    const [selectedFeeType, setSelectedFeeType] = useState<string>("SKOLNE");
                    ...
                    <div className="idsk-docs__row">
                        <aside className="idsk-docs__sidenav" aria-label="Navigácia sekcií">
                            <ul className="idsk-docs__list govuk-list">
                                ...
                                <li className="idsk-docs__item">
                                    <Link className="idsk-docs__link is-active" href="/payment-management/payment-input-tuition" title="Zápis platieb">
                        ...
                        <main className="idsk-docs__content payments">
                            <h1 className="govuk-heading-xl">Zápis platieb - školné</h1>
